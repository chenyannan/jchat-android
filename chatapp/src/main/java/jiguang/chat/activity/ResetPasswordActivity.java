    ...
    private void initData() {
        mBtn_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String oldPsw = mOld_password.getText().toString();
                String newPsw = mNew_password.getText().toString();
                String reNewPsw = mRe_newPassword.getText().toString();
                        ...
                        JMessageClient.updateUserPassword(oldPsw, newPsw, new BasicCallback() {
                            ...
                            public void gotResult(int responseCode, String responseMessage) {
                                if (responseCode == 0) {
                                    ...
                                    dialog.dismiss();
                                    HandleResponseCode.onHandle(ResetPasswordActivity.this, responseCode, false);
                                }
                            }
                        });
                    } else {
